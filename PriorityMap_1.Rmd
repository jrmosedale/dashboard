...
- Non-statutory designations based on biodiversity value.   
...
- Soil erosion  
- Flood mitigation   
- Water quality (for drinking, bathing and aquaculture waters)  
- Carbon storage  
- Pollination  
...
- Alternative use & land cost constraints:  
    + Negative weighting for built-up areas   
    + Agricultural land grade or prices  
    + Existing / recent planning commitments – allocation areas.  
- Land ownership, management & designations:  
    + Ownership: National Trust, Council assets, NGO assets, CWT, RSPB, Duchy of Cornwall, Tregothan estate, Trewithen, St Albans, other?  
    + Landscape or Heritage designation (could constrain or facilitate?)  
    + High-level agri-environment stewardship schemes.  
    + Open access to land?   
- Physical constraints on opportunities:  
    + Elevation/topography/soil type/inter-tidal zone?  
