...
woodland.opp.filename<-paste0("maps/","opps/opp_woodland_map_v19.html")
...
glynnval.3d.filename<-paste0("maps/","threed/map3d_glynvalley.html")

htmltools::tags$iframe(src = glynnval.3d.filename, frameborder="1", style="overflow: hidden; height: 100%; width: 80%; position: absolute;")
