...
opp.synthesis.filename<-paste0("maps/","opps/opptype_wd19_wt12_gr05_v1_raster.tif.html")
...
```{r, echo=FALSE}
# synthmaptext.filename<-paste0("documentation/","GrasslandOpportunityMap_text.html")
